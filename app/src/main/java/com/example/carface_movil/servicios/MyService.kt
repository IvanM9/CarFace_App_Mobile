package com.example.carface_movil.servicios
...
class MyService : Service() {
    ...
    override fun onCreate() {
        // Aquí inicializa el com.example.carface_movil.socket.WebSocketManager y el hilo para ejecutarlo en segundo plano
        /*webSocketManager = com.example.carface_movil.socket.WebSocketManager()
